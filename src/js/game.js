...
if (window.localStorage.PlayerOne != undefined && window.localStorage.PlayerTwo != undefined) {
    ...
    // If the player lands right here- these will be the default players
    alert('Character selection went wrong :( But enjoy with default characters!')
    var playerSettingOne = 'Black Widow'
    var playerSettingTwo = 'Spider man'
}
settings.forEach(e => {
...
// Players - you have to pass an object with argument [Destructuring JS]
const player = new Fighter({
    ...
    framesHold: 10,
    scale: 1.8,
    offset: { //where it will be in the background
        x: 215,
        y: 147
    },
    sprites: {
